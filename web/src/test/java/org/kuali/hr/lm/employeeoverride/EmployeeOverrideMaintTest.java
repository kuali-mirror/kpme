...
public class EmployeeOverrideMaintTest extends KPMEWebTestCase{
	...
	public void testAddNew() throws Exception {
	  	...
	  	HtmlUnitUtil.setFieldValue(page, "document.documentHeader.documentDescription", "Employee Override");
	    HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.effectiveDate", "04/01/2011");
	    HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.principalId", "test");	// nonexist principal HR attributes
	    HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.accrualCategory", "test");	//nonexist accrual catetory
	    HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.overrideTypeMax Transfer Amount", "on");
	    HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.overrideValue", "123456");	//max length is 5
	  	...
	  	HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.overrideValue", "123");
	  	HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.principalId", "111"); // existing principal HR Attributes
	  	HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.accrualCategory", "testAC2"); // existing accrual category, inconsistent leave plan
