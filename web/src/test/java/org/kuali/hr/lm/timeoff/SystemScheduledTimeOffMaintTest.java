...
public class SystemScheduledTimeOffMaintTest extends KPMEWebTestCase{
	...
	public void testGetLeavePlanAccrualCategoryFromSelectedEarnCode() throws Exception {
        ...
        HtmlUnitUtil.setFieldValue(page, "document.documentHeader.documentDescription", "something clever...");
	  	HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.effectiveDate", validDateString);
	    HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.earnCode", "EC");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.descr", "this is my description");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.amountofTime", "8");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.location", "CST");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.accruedDate", validDateString);
