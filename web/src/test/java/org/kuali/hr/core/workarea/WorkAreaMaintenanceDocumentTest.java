...
public class WorkAreaMaintenanceDocumentTest extends KPMEWebTestCase {
    ...
    public void testCreateNew() throws Exception {
        ...
        HtmlUnitUtil.setFieldValue(page, "document.documentHeader.documentDescription", "Work Area - test");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.effectiveDate", "4/01/2011");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.active", "on");
        ...
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.add.principalRoleMembers.effectiveDate", "04/01/2011");
        HtmlUnitUtil.setFieldValue(page, "document.newMaintainableObject.add.principalRoleMembers.principalId", "admin");
