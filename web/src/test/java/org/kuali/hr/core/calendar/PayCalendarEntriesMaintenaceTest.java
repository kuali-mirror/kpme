...
public class PayCalendarEntriesMaintenaceTest extends KPMEWebTestCase {
	...
	public void testSubmitPayCalendarEntriesMaint() throws Exception {
    	//String baseUrl = HtmlUnitUtil.getBaseURL() + "/kr/maintenance.do?businessObjectClassName=org.kuali.kpme.tklm.time.paycalendar.PayCalendarEntry&methodToCall=start";
		String baseUrl = HrTestConstants.Urls.PAY_CALENDAR_ENTRY_MAINT_NEW_URL;
