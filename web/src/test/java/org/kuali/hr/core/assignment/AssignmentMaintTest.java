...
public class AssignmentMaintTest extends KPMEWebTestCase {
	...
	public void testAssignmentCreateNew() throws Exception {
    	...
    	HtmlUnitUtil.setFieldValue(page, "document.documentHeader.documentDescription", "Assignment - test");
	...
	public void testAssignmentCreateNewJobValidation() throws Exception {
		...
		Assert.assertNotNull("Could not locate document overview description field", descriptionText);
		...
		Assert.assertNotNull("Could not locate effective date field", effDateText);
		...
		Assert.assertNotNull("Could not locate principal id field", principalText);
		...
		Assert.assertNotNull("Could not locate job number field", jobNumberText);
		...
		Assert.assertNotNull("Could not locate work area field", workAreaText);
