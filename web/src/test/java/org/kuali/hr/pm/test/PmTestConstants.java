...
public final class PmTestConstants {
	...
	public static class Urls {
		...
		public static final String INSTITUTION_MAINT_NEW_URL = BASE_URL + "/kr/maintenance.do?businessObjectClassName=org.kuali.hr.core.bo.institution.Institution&methodToCall=start";

		public static final String PAY_STEP_MAINT_NEW_URL = BASE_URL + "/kr/maintenance.do?businessObjectClassName=org.kuali.hr.core.bo.paystep.PayStep&methodToCall=start";
