...
public class WeeklyOvertimeRuleGroupMaintenanceTest extends WeeklyOvertimeRuleMaintenanceTest {
	...
	public void testSubmitWeeklyOvertimeRuleGroupMaint() throws Exception {
    	String baseUrl = HtmlUnitUtil.getBaseURL() + "/kr/maintenance.do?businessObjectClassName=org.kuali.hr.tklm.time.overtime.weekly.rule.WeeklyOvertimeRuleGroup&methodToCall=edit";
        ...
        element = (HtmlElement)page.getElementById("methodToCall.addLine.lstWeeklyOvertimeRules.(!!org.kuali.hr.tklm.time.overtime.weekly.rule.WeeklyOvertimeRule!!)");
