...
public class DepartmentLunchRuleMaintTest extends KPMEWebTestCase {
	...
	public void testDepartmentLunchRuleMaintForMaxShiftHourErrorMessage() throws Exception {
		...
		HtmlUnitUtil.setFieldValue(maintPage, HrTestConstants.DOC_NEW_ELEMENT_ID_PREFIX + "shiftHours", "34");
		HtmlUnitUtil.setFieldValue(maintPage, "document.documentHeader.documentDescription", "test");
