...
insert into lm_leave_adjustment_t (`LM_LEAVE_ADJUSTMENT_ID`, `PRINCIPAL_ID`, `ACCRUAL_CAT`, `LEAVE_PLAN`, `EARN_CODE`, `ADJUSTMENT_AMOUNT`, `DESCRIPTION`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `effdt`) values (	'3000',	'10001',	'AC1',	'IU-SM',	'testLC',	10,	'test 1239',	'2012-01-31 11:03:11',	'8B5039D6-5775-87AA-9012-1A6EDEB0FD16',	1, '2010-01-01');
insert into hr_earn_code_t values('5000', 'EC', 'test', '2012-02-01', 'Y', 'Y', 'B2991ADA-E866-F28C-7E95-A897AC377D0C', '1', now(), 'testAC', '1.5', '1.5', 'Hours', 'testLP', 'None', '99.9', 'T', 'N', 'Y', 'Y', 'Y', 'Y', 'test', null, 'N', 'I', 'N');
