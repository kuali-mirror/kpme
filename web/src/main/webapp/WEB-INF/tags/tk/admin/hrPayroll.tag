    ...
    <ul class="chan">
        ...
        <li>
            <portal:portalLink displayTitle="true" title="Principal HR Attributes"
                               url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.kpme.core.principal.PrincipalHRAttributesBo&returnLocation=${ConfigProperties.application.url}/portal.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y"/>
        </li>
    </ul>
    <strong> </strong>
    <ul class="chan">
        ...
        <li>
            <portal:portalLink displayTitle="true" title="Earn Code Security"
                               url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.kpme.core.earncode.security.EarnCodeSecurityBo&returnLocation=${ConfigProperties.application.url}/portal.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y" />
        </li>
        <li>
            <portal:portalLink displayTitle="true" title="Earn Code Group"
                               url="${ConfigProperties.application.url}/kr-krad/lookup.do?methodToCall=start&dataObjectClassName=org.kuali.kpme.core.earncode.group.EarnCodeGroupBo&returnLocation=${ConfigProperties.application.url}/portal.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y" />
        </li>
        <li>
    ...
    <ul class="chan">
        <li>
            <portal:portalLink displayTitle="true" title="Department Affiliation"
                               url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.kpme.core.departmentaffiliation.DepartmentAffiliationBo&returnLocation=${ConfigProperties.application.url}/portal.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y"/>
