    ...
    <ul class="chan">
        ...
        <li>
            <portal:portalLink displayTitle="true" title="Calendar Entry"
                               url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.kpme.core.calendar.entry.CalendarEntry&returnLocation=${ConfigProperties.application.url}/portal.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y" />
        </li>
        <li>
