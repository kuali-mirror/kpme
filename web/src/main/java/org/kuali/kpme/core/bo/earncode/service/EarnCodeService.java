...
public interface EarnCodeService {
     ...
     * @return
     */
    @Cacheable(value=EarnCode.CACHE_NAME, key="'{getEarnCodesForLeaveAndTime}' + 'principalId=' + T(org.kuali.kpme.tklm.common.TKContext).getPrincipalId() + '|' + 'targetId=' + T(org.kuali.kpme.tklm.common.TKContext).getTargetPrincipalId() + '|' + 'a=' + #p0.getTkAssignmentId() + '|' + 'asOfDate=' + #p1 + '|' + 'isLeavePlanningCalendar=' +#p2")
     ...
     * @return
     */
    @Cacheable(value=EarnCode.CACHE_NAME, key="'{getEarnCodesForTime}' + 'principalId=' + T(org.kuali.kpme.tklm.common.TKContext).getPrincipalId() + '|' + 'targetId=' + T(org.kuali.kpme.tklm.common.TKContext).getTargetPrincipalId() + '|' + 'a=' + #p0.getTkAssignmentId() + '|' + 'asOfDate=' + #p1")
	 ...
	 * @return
	 */
    @Cacheable(value=EarnCode.CACHE_NAME, key="'{getEarnCodesForLeave}' + 'principalId=' + T(org.kuali.kpme.tklm.common.TKContext).getPrincipalId() + '|' + 'targetId=' + T(org.kuali.kpme.tklm.common.TKContext).getTargetPrincipalId() + '|' + 'a=' + #p0.getTkAssignmentId() + '|' + 'asOfDate=' + #p1 + '|' + 'isLeavePlanningCalendar=' +#p2")
