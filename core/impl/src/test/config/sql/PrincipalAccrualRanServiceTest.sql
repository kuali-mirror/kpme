...
insert into hr_job_t (`hr_job_id`, `PRINCIPAL_ID`, `JOB_NUMBER`, `EFFDT`, `dept`, `HR_SAL_GROUP`, `pay_grade`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `comp_rate`, `GRP_KEY_CD`, `std_hours`, `hr_paytype`, `active`, `primary_indicator`, `position_nbr`, `eligible_for_leave`, `FLSA_STATUS`) values ('5002', 'testUser', '3', '2012-03-01', 'TEST-DEPT', 'SD1', 'SD1', '2012-06-01 10:00:00', uuid(), '2', '0.000000', 'IU-IN', '40.00', 'BW', 'Y',  'Y', 'N', 'Y', null);
# this job has an older timestamp than 2012-05-01
insert into hr_job_t (`hr_job_id`, `PRINCIPAL_ID`, `JOB_NUMBER`, `EFFDT`, `dept`, `HR_SAL_GROUP`, `pay_grade`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `comp_rate`, `GRP_KEY_CD`, `std_hours`, `hr_paytype`, `active`, `primary_indicator`, `position_nbr`, `eligible_for_leave`, `FLSA_STATUS`) values ('5001', 'testUser', '3', '2012-03-01', 'TEST-DEPT', 'SD1', 'SD1', '2012-04-01 10:00:00', uuid(), '1', '0.000000', 'IU-IN', '40.00', 'BW', 'Y',  'Y', 'N', 'Y', null);
