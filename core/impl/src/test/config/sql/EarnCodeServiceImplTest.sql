...
insert into tk_assignment_t (tk_assignment_id, PRINCIPAL_ID, JOB_NUMBER, EFFDT, WORK_AREA, TASK, OBJ_ID, VER_NBR, active, timestamp, GRP_KEY_CD) values('10000', 'testuser', '1234', '2010-01-01', '1', '30', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', 'Y', '2010-07-27 10:25:13', 'IU-BL');
insert into tk_assignment_t (tk_assignment_id, PRINCIPAL_ID, JOB_NUMBER, EFFDT, WORK_AREA, TASK, OBJ_ID, VER_NBR, active, timestamp, GRP_KEY_CD) values('10001', 'testuser', '5678', '2010-01-01', '1', '30', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', 'Y', '2010-07-27 10:25:13', 'IU-BL');
insert into hr_job_t (`hr_job_id`, `PRINCIPAL_ID`, `JOB_NUMBER`, `EFFDT`, `dept`, `HR_SAL_GROUP`, `pay_grade`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `comp_rate`, `GRP_KEY_CD`, `std_hours`, `hr_paytype`, `active`, `primary_indicator`, `position_nbr`, `eligible_for_leave`, `FLSA_STATUS`) values ('10000', 'testuser', '1234', '2012-01-01', 'TEST-DEPT', 'SD1', 'SD1', '2012-01-01 11:00:00', uuid(), '1', '0.000000', 'IU-IN', '40.00', 'EC1', 'Y',  'Y', 'N', 'N', null);
insert into hr_job_t (`hr_job_id`, `PRINCIPAL_ID`, `JOB_NUMBER`, `EFFDT`, `dept`, `HR_SAL_GROUP`, `pay_grade`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `comp_rate`, `GRP_KEY_CD`, `std_hours`, `hr_paytype`, `active`, `primary_indicator`, `position_nbr`, `eligible_for_leave`, `FLSA_STATUS`) values ('10001', 'testuser', '5678', '2012-01-01', 'TEST-DEPT', 'SD1', 'SD1', '2012-01-01 11:00:00', uuid(), '1', '0.000000', 'IU-IN', '40.00', 'EC2', 'Y',  'Y', 'N', 'N', null);
insert into hr_paytype_t (`hr_paytype_id`, `PAYTYPE`, `DESCR`, `reg_ern_code`, `EFFDT`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `ACTIVE`, `GRP_KEY_CD`) values ('10000', 'EC1', 'description', 'EC1', '2010-01-01', '2012-01-01 11:00:00', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', 'Y', '*-*');
insert into hr_paytype_t (`hr_paytype_id`, `PAYTYPE`, `DESCR`, `reg_ern_code`, `EFFDT`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `ACTIVE`, `GRP_KEY_CD`) values ('10001', 'EC2', 'description', 'EC2', '2010-01-01', '2012-01-01 11:00:00', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', 'Y', '*-*');
