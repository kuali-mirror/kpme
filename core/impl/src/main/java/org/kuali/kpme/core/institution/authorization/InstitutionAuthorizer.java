...
package org.kuali.kpme.core.institution.authorization;
 ...
 */
public class InstitutionAuthorizer extends KPMEMaintenanceDocumentAuthorizerBase {
    ...
    public boolean canCopy(Document document, Person user) {
        return canCreate(((MaintenanceDocument)document).getDocumentDataObject().getClass(), user);
    }
}
