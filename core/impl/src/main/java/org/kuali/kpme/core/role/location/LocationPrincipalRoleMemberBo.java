...
public class LocationPrincipalRoleMemberBo extends PrincipalRoleMemberBo implements LocationPrincipalRoleMemberBoContract {
	...
	public static LocationPrincipalRoleMemberBo from(RoleMemberBo roleMemberBo, Map<String, String> attributes) {
        ...
        LocationPrincipalRoleMemberBo.Builder b = new LocationPrincipalRoleMemberBo.Builder(roleMemberBo.getRoleId(), roleMemberBo.getMemberId(), roleMemberBo.getType());
	...
	public LocationPrincipalRoleMemberBo() {
		super();
	}
	
    private LocationPrincipalRoleMemberBo(Builder b) {
        setId(b.getId());
	...
	public static final class Builder implements ModelBuilder, ModelObjectComplete {
		...
		private static final long serialVersionUID = 8683798354938317359L;
        ...
        @Override
        public LocationPrincipalRoleMemberBo build() {
            return new LocationPrincipalRoleMemberBo(this);
        }
