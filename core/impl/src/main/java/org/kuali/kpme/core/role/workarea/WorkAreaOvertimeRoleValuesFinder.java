...
public class WorkAreaOvertimeRoleValuesFinder extends KeyValuesBase {
	...
	static {
		...
		WORK_AREA_OVERTIME_ROLE_KEY_VALUES.add(new ConcreteKeyValue(KPMERole.PAYROLL_PROCESSOR.getRoleName(), KPMERole.PAYROLL_PROCESSOR.getRoleName())); //KPME-2769
		//WORK_AREA_OVERTIME_ROLE_KEY_VALUES.add(new ConcreteKeyValue(KPMERole.APPROVER_DELEGATE.getRoleName(), KPMERole.APPROVER_DELEGATE.getRoleName()));  //KPME-2769  
		...
		//WORK_AREA_OVERTIME_ROLE_KEY_VALUES.add(new ConcreteKeyValue(KPMERole.LEAVE_DEPARTMENT_ADMINISTRATOR.getRoleName(), KPMERole.LEAVE_DEPARTMENT_ADMINISTRATOR.getRoleName()));  //KPME-2769
	}
