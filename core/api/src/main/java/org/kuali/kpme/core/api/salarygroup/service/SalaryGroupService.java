...
public interface SalaryGroupService {
    ...
    List<SalaryGroup> getSalaryGroups(String salGroup, String groupKeyCode, String leavePlan, LocalDate fromEffdt, LocalDate toEffdt, String active, String showHist, String benefitEligible, String leaveEligible, String percentTime);
}
