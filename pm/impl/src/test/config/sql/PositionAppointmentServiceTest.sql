...
insert into PM_PSTN_APPOINTMENT_T (`pm_pstn_appointment_id`, `pstn_appointment`, `description`, `grp_key_cd`, `effdt`, `active`, `timestamp`, `obj_id`, `ver_nbr`) values ('123456789', 'testAppointment', 'This is a test appointment description', 'UGA-ATHENS', '2012-01-01', 'Y', now(), null, '1');
