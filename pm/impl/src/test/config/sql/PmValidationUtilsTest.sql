...
insert into PM_PSTN_RPT_TYP_T (`pm_pstn_rpt_typ_id`, `pstn_rpt_typ`, `description`, `effdt`, `active`,  `timestamp`, `obj_id`, `ver_nbr` ) values ('5000', 'testPRT', null, '2012-01-01', 'Y', now(), uuid(), '1');
insert into PM_PSTN_RPT_CAT_T (`pm_pstn_rpt_cat_id`, `pstn_rpt_cat`, `pstn_rpt_type`, `description`, `effdt`, `active`,  `timestamp`, `obj_id`, `ver_nbr` ) values ('5000', 'testPRC', 'testPRT', null, '2012-01-01', 'Y', now(), uuid(), '1');
insert into PM_PSTN_RPT_SUB_CAT_T (`pm_pstn_rpt_sub_cat_id`, `pstn_rpt_sub_cat`, `pstn_rpt_cat`, `pstn_rpt_type`, `description`, `effdt`, `active`,  `timestamp`, `obj_id`, `ver_nbr`) values ('5000', 'testPRSC', 'testPRC', 'testPRT', null,  '2012-01-01', 'Y', now(), uuid(), '1');
insert into PM_PSTN_RPT_GRP_T (`pm_pstn_rpt_grp_id`, `pstn_rpt_grp`, `description`, `effdt`, `active`,  `timestamp`, `obj_id`, `ver_nbr` ) values ('5000', 'testPRG', null, '2012-01-01', 'Y', now(), uuid(), '1');
