...
public class PstnRptGrpSubCatDaoObjImpl extends PlatformAwareDaoBaseOjb  implements PstnRptGrpSubCatDao{
	...
	@Override
	public PositionReportGroupSubCategoryBo getPstnRptGrpSubCatById(
			String pmPstnRptGrpSubCatId) {
		Criteria crit = new Criteria();
        crit.addEqualTo("pmPstnRptGrpSubCatId", pmPstnRptGrpSubCatId);

        Query query = QueryFactory.newQuery(PositionReportGroupSubCategoryBo.class, crit);
        return (PositionReportGroupSubCategoryBo) this.getPersistenceBrokerTemplate().getObjectByQuery(query);
	}
