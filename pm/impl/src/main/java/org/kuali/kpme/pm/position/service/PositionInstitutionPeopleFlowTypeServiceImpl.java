...
public class PositionInstitutionPeopleFlowTypeServiceImpl extends DataDictionaryPeopleFlowTypeServiceImpl {
    private static final Logger LOG = Logger.getLogger(PositionInstitutionPeopleFlowTypeServiceImpl.class);
    @Override
