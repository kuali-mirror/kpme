...
public class ClassificationQualificationDaoObjImpl extends PlatformAwareDaoBaseOjb implements ClassificationQualificationDao {
	...
	public List<ClassificationQualificationBo> getQualListForClassification(String pmClassificationId) {
		List<ClassificationQualificationBo> qualList = new ArrayList<ClassificationQualificationBo>();
		Criteria crit = new Criteria();
        crit.addEqualTo("pmPositionClassId", pmClassificationId);

        Query query = QueryFactory.newQuery(ClassificationQualificationBo.class, crit);
