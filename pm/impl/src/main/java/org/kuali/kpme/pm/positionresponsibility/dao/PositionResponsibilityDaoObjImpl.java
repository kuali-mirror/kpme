...
public class PositionResponsibilityDaoObjImpl extends PlatformAwareDaoBaseOjb implements PositionResponsibilityDao {
	...
	@Override
	public PositionResponsibilityBo getPositionResponsibilityById(
			String positionResponsibilityId) {
		Criteria crit = new Criteria();
        crit.addEqualTo("positionResponsibilityId", positionResponsibilityId);

        Query query = QueryFactory.newQuery(PositionResponsibilityBo.class, crit);
        return (PositionResponsibilityBo) this.getPersistenceBrokerTemplate().getObjectByQuery(query);
	}
