...
<script lang="text/javascript">
    var editReviewLevels = new Array();
    editReviewLevels = ${authorizedEditReviewLevels} ;
    currentDossierLevel = ${currentDossierLevel};
                ...
                "aoColumnDefs"  : [
                    ...
                    },
                    {
                        ...
                        fnCreatedCell: function(nTd, sData, oData, iRow, iCol){
                            ...
                            var isPending = !oData[9];
                            if ((currentDossierLevel == Number(itemLevel)) && (editReviewLevels.indexOf(Number(itemLevel)) != -1) && isPending) {
                ...
                buttons: [
                    { text: "Delete File",
                        click: function() {
                            ...
                            var frmDelFile = $('<form>', {
                                "id": "frmdelfile",
                                "name": "EdoReviewLetterForm",
                                "action": "EdoReviewLetter.do",
                                "html": sFields,
                                "method": "post"
                            });
