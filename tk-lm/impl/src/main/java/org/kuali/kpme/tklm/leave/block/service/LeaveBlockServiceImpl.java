...
public class LeaveBlockServiceImpl implements LeaveBlockService {
    ...
    protected List<LeaveBlockBo> saveLeaveBlockBos(List<LeaveBlockBo> leaveBlocks) {
        ...
        Collection<LeaveBlockBo> savedObjects = (Collection<LeaveBlockBo>) KRADServiceLocatorWeb.getLegacyDataAdapter().save(leaveBlocks);
        ...
        KRADServiceLocatorWeb.getLegacyDataAdapter().save(leaveBlockHistories);
...
//        leaveBlock.setTimestamp(TKUtils.getCurrentTimestamp());
        ...
        // deleting leaveblock
        KRADServiceLocatorWeb.getLegacyDataAdapter().delete(leaveBlock);
        
        // creating history
        KRADServiceLocatorWeb.getLegacyDataAdapter().save(leaveBlockHistory);
    ...
    public LeaveBlock saveLeaveBlock(LeaveBlock leaveBlock, String principalId) {
    	...
    	KRADServiceLocatorWeb.getLegacyDataAdapter().delete(existingLB);
    	...
    	savedLeaveBlock = KRADServiceLocatorWeb.getLegacyDataAdapter().save(existingLB);
...
//          throw new RuntimeException("Calendar Entry parameter is null.");
    ...
    public void updateLeaveBlock(LeaveBlock leaveBlock, String principalId) {
        ...
        KRADServiceLocatorWeb.getLegacyDataAdapter().save(leaveBlockBo);
