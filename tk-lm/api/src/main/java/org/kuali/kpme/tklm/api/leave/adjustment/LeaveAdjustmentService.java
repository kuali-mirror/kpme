...
public interface LeaveAdjustmentService {
	...
	public List<? extends LeaveAdjustmentContract> getLeaveAdjustments(LocalDate fromEffdt, LocalDate toEffdt, String principalId, String accrualCategory, String earnCode);
}
