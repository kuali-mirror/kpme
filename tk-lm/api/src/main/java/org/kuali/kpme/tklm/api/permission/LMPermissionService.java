...
public interface LMPermissionService {
	...
	boolean canEditLeaveBlock(String principalId, LeaveBlockContract leaveBlock);

	boolean canDeleteLeaveBlock(String principalId, LeaveBlockContract leaveBlock);
	 ...
	 * @return
	 */
	boolean canBankOrTransferSSTOUsage(LeaveBlockContract leaveBlock);
	 ...
	 * @return
	 */
	boolean canTransferSSTOUsage(LeaveBlockContract leaveBlock);
	 ...
	 * @return
	 */
	boolean canBankSSTOUsage(LeaveBlockContract leaveBlock);
