...
--  Changeset src/main/config/db/2.1.0/db.changelog-201312101300.xml::3::jwillia::(Checksum: 3:b3da8195b7bd94115c24c2782c867dd1)
...
--  Changeset src/main/config/db/2.1.0/db.changelog-201404021045.xml::1::jwillia::(Checksum: 3:5a81d0e2a0ffc93e82fcb970292ed046)
ALTER TABLE `HR_DEPT_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `HR_DEPT_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `HR_CALENDAR_ENTRIES_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `HR_CALENDAR_ENTRIES_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `HR_CALENDAR_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `HR_CALENDAR_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `HR_PAY_GRADE_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `HR_PAY_GRADE_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `LM_BALANCE_TRANSFER_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `LM_BALANCE_TRANSFER_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `LM_LEAVE_PAYOUT_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `LM_LEAVE_PAYOUT_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `LM_PRIN_ACCR_RAN_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `LM_PRIN_ACCR_RAN_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `TK_CLOCK_LOC_RL_IP_ADDR_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `TK_CLOCK_LOC_RL_IP_ADDR_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `TK_SHIFT_DIFFERENTIAL_RL_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `TK_SHIFT_DIFFERENTIAL_RL_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `TK_DAILY_OVERTIME_RL_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `TK_DAILY_OVERTIME_RL_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `TK_USER_PREF_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `TK_USER_PREF_T` ADD `OBJ_ID` VARCHAR(36);

ALTER TABLE `TK_WEEKLY_OVT_GROUP_T` ADD `VER_NBR` BIGINT(20) NOT NULL DEFAULT '1';
...
--  Changeset src/main/config/db/2.1.0/db.changelog-201404031000.xml::9::jjhanso::(Checksum: 3:6c738e7d1f6a279c9f509ba20c970fa2)
...
CREATE INDEX `TK_TIME_BLOCK_HIST_IDX1` ON `TK_TIME_BLOCK_T`(`PRINCIPAL_ID`, `DOCUMENT_ID`, `GRP_KEY_CD`, `JOB_NUMBER`, `WORK_AREA`, `TASK`, `EARN_CODE`, `BEGIN_TS`, `END_TS`, `TIMESTAMP`, `CLOCK_LOG_CREATED`);
...
--  Changeset src/main/config/db/2.1.0/db.changelog-201405191030.xml::1::jkakkad::(Checksum: 3:07de53e631c5968eec57dabc8ddef9f6)
ALTER TABLE `PM_PSTN_RPT_TYP_T` ADD `LOCATION` VARCHAR(15);

ALTER TABLE `PM_PSTN_RPT_TYP_T` ADD `INSTITUTION` VARCHAR(15);

ALTER TABLE `PM_PSTN_RPT_TYP_T` MODIFY `LOCATION` VARCHAR(15) NULL;

ALTER TABLE `PM_PSTN_RPT_TYP_T` MODIFY `INSTITUTION` VARCHAR(15) NULL;
...
--  Changeset src/main/config/db/2.1.0/db.changelog-201405201130.xml::1::umehta::(Checksum: 3:9f5ebe7b274b81b44c0b799d80ee82ff)
...
ALTER TABLE `PM_PSTN_RPT_GRP_SUB_CAT_T` MODIFY `LOCATION` VARCHAR(15) NULL;

ALTER TABLE `PM_PSTN_RPT_GRP_SUB_CAT_T` MODIFY `INSTITUTION` VARCHAR(15) NULL;
...
--  Changeset src/main/config/db/2.1.0/db.changelog-201406161300.xml::1::mlemons::(Checksum: 3:6b4ef755665695de25ef752153010444)
ALTER TABLE `HR_EARN_CODE_SECURITY_T` MODIFY `LOCATION` VARCHAR(30) NULL;


--  Changeset src/main/config/db/2.1.0/db.changelog-201407081600.xml::1::mlemons::(Checksum: 3:41b4b6383184ec4888319605bb581239)
