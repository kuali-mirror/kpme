...
--  Changeset src/main/config/db/2.1.0/db.changelog-201407101500.xml::1::mlemons::(Checksum: 3:91bbb16bed19dd61e5365ad56ca2a10c)
...
INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Edit Institution'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-PM' AND ROLE_NM = 'Position System Administrator'), 'KPME0912', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Create Institution'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-PM' AND ROLE_NM = 'Position System Administrator'), 'KPME0913', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Edit Organization'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time System Administrator'), 'KPME0914', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Create Organization'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time System Administrator'), 'KPME0915', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Edit Organization'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-LM' AND ROLE_NM = 'Leave System Administrator'), 'KPME0916', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Create Organization'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-LM' AND ROLE_NM = 'Leave System Administrator'), 'KPME0917', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Edit Organization'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-PM' AND ROLE_NM = 'Position System Administrator'), 'KPME0918', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-HR' AND NM = 'Create Organization'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-PM' AND ROLE_NM = 'Position System Administrator'), 'KPME0919', '1');
...
--  Changeset src/main/config/db/2.1.0/db.changelog-201407120300.xml::1::jkakkad::(Checksum: 3:e44c5b3ec1b82615771085d3b77414d3)
--  KPME-3695 - Adding Rice KIM Role Permissions bootstrap data
INSERT INTO `KRIM_PERM_T` (`ACTV_IND`, `DESC_TXT`, `NM`, `NMSPC_CD`, `OBJ_ID`, `PERM_ID`, `PERM_TMPL_ID`, `VER_NBR`) VALUES ('Y', 'Allows users to create a Shift Differential Rule Type', 'Create Shift Differential Rule Type', 'KPME-TK', UUID(), 'KPME0188', (SELECT PERM_TMPL_ID FROM KRIM_PERM_TMPL_T WHERE NMSPC_CD = 'KPME-WKFLW' AND NM = 'Create KPME Maintenance Document'), '1');

INSERT INTO `KRIM_PERM_ATTR_DATA_T` (`ATTR_DATA_ID`, `ATTR_VAL`, `KIM_ATTR_DEFN_ID`, `KIM_TYP_ID`, `OBJ_ID`, `PERM_ID`, `VER_NBR`) VALUES ('KPME0196', 'ShiftDifferentialRuleTypeDocumentType', (SELECT KIM_ATTR_DEFN_ID FROM KRIM_ATTR_DEFN_T WHERE NMSPC_CD = 'KR-WKFLW' AND NM = 'documentTypeName'), (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NMSPC_CD = 'KR-SYS' AND NM = 'Document Type & Routing Node or State'), UUID(), 'KPME0188', '1');

INSERT INTO `KRIM_PERM_T` (`ACTV_IND`, `DESC_TXT`, `NM`, `NMSPC_CD`, `OBJ_ID`, `PERM_ID`, `PERM_TMPL_ID`, `VER_NBR`) VALUES ('Y', 'Allows users to edit a Shift Differential Rule Type', 'Edit Shift Differential Rule Type', 'KPME-TK', UUID(), 'KPME0189', (SELECT PERM_TMPL_ID FROM KRIM_PERM_TMPL_T WHERE NMSPC_CD = 'KPME-WKFLW' AND NM = 'Edit KPME Maintenance Document'), '1');

INSERT INTO `KRIM_PERM_ATTR_DATA_T` (`ATTR_DATA_ID`, `ATTR_VAL`, `KIM_ATTR_DEFN_ID`, `KIM_TYP_ID`, `OBJ_ID`, `PERM_ID`, `VER_NBR`) VALUES ('KPME0197', 'ShiftDifferentialRuleTypeDocumentType', (SELECT KIM_ATTR_DEFN_ID FROM KRIM_ATTR_DEFN_T WHERE NMSPC_CD = 'KR-WKFLW' AND NM = 'documentTypeName'), (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NMSPC_CD = 'KR-SYS' AND NM = 'Document Type & Routing Node or State'), UUID(), 'KPME0189', '1');

INSERT INTO `KRIM_PERM_T` (`ACTV_IND`, `DESC_TXT`, `NM`, `NMSPC_CD`, `OBJ_ID`, `PERM_ID`, `PERM_TMPL_ID`, `VER_NBR`) VALUES ('Y', 'Allows users to view Shift Differential Rule Type', 'View Shift Differential Rule Type', 'KPME-TK', UUID(), 'KPME0190', (SELECT PERM_TMPL_ID FROM KRIM_PERM_TMPL_T WHERE NMSPC_CD = 'KPME-WKFLW' AND NM = 'View KPME Record'), '1');

INSERT INTO `KRIM_PERM_ATTR_DATA_T` (`ATTR_DATA_ID`, `ATTR_VAL`, `KIM_ATTR_DEFN_ID`, `KIM_TYP_ID`, `OBJ_ID`, `PERM_ID`, `VER_NBR`) VALUES ('KPME0198', 'ShiftDifferentialRuleTypeDocumentType', (SELECT KIM_ATTR_DEFN_ID FROM KRIM_ATTR_DEFN_T WHERE NMSPC_CD = 'KR-WKFLW' AND NM = 'documentTypeName'), (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NMSPC_CD = 'KR-SYS' AND NM = 'Document Type & Routing Node or State'), UUID(), 'KPME0190', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'View Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time Location Administrator'), 'KPME0926', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'View Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time Department Administrator'), 'KPME0927', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'View Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time System Administrator'), 'KPME0928', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'View Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time System View Only'), 'KPME0929', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'View Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time Location View Only'), 'KPME0930', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'View Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time Department View Only'), 'KPME0931', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'Create Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time System Administrator'), 'KPME0932', '1');

INSERT INTO `KRIM_ROLE_PERM_T` (`ACTV_IND`, `OBJ_ID`, `PERM_ID`, `ROLE_ID`, `ROLE_PERM_ID`, `VER_NBR`) VALUES ('Y', UUID(), (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KPME-TK' AND NM = 'Edit Shift Differential Rule Type'), (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KPME-TK' AND ROLE_NM = 'Time System Administrator'), 'KPME0933', '1');
