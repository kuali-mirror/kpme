	...
	<html:form action="/Leave.do" method="POST">
		...
		<div class="person-detail">
			...
			<div id="person-detail-accordion">
					...
					<table>
						...
						<c:if test="${fn:length(Form.plannedLeaves) > 0}">
							...
							<tr>
								...
								<input type="submit" class="approve" value="Submit" name="Submit" /></td>
							</tr>
						</c:if>
					</table>
				</div>

				<h3><a href="#">Leave Request Pending Approval</a></h3>
				<div>
				<table>
					<tr>
						<th>Date</th>
				...
				<h3><a href="#">Approved Leave Requests</a></h3>
				<div>
					<table>
						<tr>
							<th>Date</th>
						...
						<c:if test="${fn:length(Form.disapprovedLeaves) > 0}">
							<c:forEach var="disaprovedLeave"
								...
								<tr>
									...
									<td>${disaprovedLeave.hours}</td>
									<td>${disaprovedLeave.requestStatus == 'D' ? 'Disapprove' : 'Defer'}</td>
