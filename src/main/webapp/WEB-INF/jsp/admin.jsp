                    ...
                    <b>Administrative Activities</b>
                     <ul>
							<c:if test="${Form.user.systemAdmin}">
								...
								<li><a
									href="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.hr.lm.accrual.AccrualCategory&returnLocation=${ConfigProperties.application.url}/Admin.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y">Accrual
										Category</a>
								</li>
								<li><a
								...
								<li><a
									href="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.hr.time.calendar.CalendarEntries&returnLocation=${ConfigProperties.application.url}/Admin.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y">Calendar Entry</a>
								</li>
								<li><a
