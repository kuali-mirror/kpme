                ...
                <td>
                    ...
                    <b>Administrative Activities</b>
                     <ul>
                        ...
                        <li><a href="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.hr.time.workschedule.WorkSchedule&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888">Work Schedule</a></li>                        
                    </ul>                  
            </tr>
        </table>
    </div>
