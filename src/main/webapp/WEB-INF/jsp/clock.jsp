	...
	<div id="clock">
		<table>
			...
			<tr>
				...
				<fmt:timeZone value="${Form.user.currentUserPreferences.timezone}"><fmt:formatDate type="both" value="${Form.lastClockTimeWithZone}" pattern="EEE, MMMM d yyyy HH:mm:ss, zzzz"/></fmt:timeZone>
				</td>
			</tr>
			<tr>
