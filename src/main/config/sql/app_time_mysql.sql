...
CREATE TABLE `tk_clock_log_s` (
  `id` bigint(19) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2178 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  SAL_GROUP_ID bigint NOT NULL PRIMARY KEY,
  SAL_GROUP VARCHAR(10) NOT NULL,
  EFFDT DATE NOT NULL,
...
(
  PAYTYPE_ID bigint NOT NULL PRIMARY KEY,
  PAYTYPE VARCHAR(5) NOT NULL,  
  DESCR VARCHAR(30) NULL,
  CALENDAR_GROUP VARCHAR(30) NOT NULL,
  REG_ERN_CODE VARCHAR(3) NOT NULL,
  EFFDT DATE NOT NULL,
  TIMESTAMP TIMESTAMP NOT NULL,
  HOLIDAY_CALENDAR_GROUP VARCHAR(30) NOT NULL, 
  OBJ_ID varchar(36) COLLATE utf8_bin DEFAULT NULL,
  VER_NBR decimal(8,0) NOT NULL DEFAULT '1' 
)
...
(
  TK_ACCRUALS_ID bigint NOT NULL PRIMARY KEY,
  PRINCIPAL_ID VARCHAR(21) NOT NULL,
  ACCRUAL_CATEGORY VARCHAR(3) NOT NULL,
  EFFDT DATETIME NOT NULL,
  HOURS_ACCRUED INT NOT NULL,
  HOURS_TAKEN INT NOT NULL,
  HOURS_ADJUST INT NOT NULL,
  OBJ_ID varchar(36) COLLATE utf8_bin DEFAULT NULL,
  VER_NBR decimal(8,0) NOT NULL DEFAULT '1'
)
...
-- Dump completed on 2010-07-09  9:29:12
