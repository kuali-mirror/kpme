...
CREATE TABLE hr_job_t (HR_JOB_ID NUMBER(38,0) NOT NULL, PRINCIPAL_ID VARCHAR2(40), JOB_NUMBER NUMBER(38,0), EFFDT DATE DEFAULT '01-JAN-1980' NOT NULL, dept VARCHAR2(90) NOT NULL, HR_SAL_GROUP VARCHAR2(10), pay_grade VARCHAR2(20), TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, OBJ_ID VARCHAR2(36), VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, comp_rate DECIMAL(18,6) DEFAULT 0, location VARCHAR2(20), std_hours DECIMAL(5,2), fte VARCHAR2(1), hr_paytype VARCHAR2(5), active VARCHAR2(1) DEFAULT 'N', primary_indicator VARCHAR2(1) DEFAULT 'N', position_nbr VARCHAR2(20), CONSTRAINT PK_HR_JOB_T PRIMARY KEY (HR_JOB_ID));
...
CREATE TABLE hr_work_schedule_assign_t (HR_WORK_SCHEDULE_ASSIGNMENT_ID NUMBER(38,0) NOT NULL, HR_WORK_SCHEDULE NUMBER(38,0) NOT NULL, DEPT VARCHAR2(21) NOT NULL, WORK_AREA NUMBER(38,0), PRINCIPAL_ID VARCHAR2(40), USER_PRINCIPAL_ID VARCHAR2(40), ACTIVE VARCHAR2(1) DEFAULT 'Y' NOT NULL, EFFDT DATE DEFAULT '01-JAN-1980' NOT NULL, TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, OBJ_ID VARCHAR2(36), VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, CONSTRAINT PK_HR_WORK_SCHEDULE_ASSIGN_T PRIMARY KEY (HR_WORK_SCHEDULE_ASSIGNMENT_ID));
CREATE SEQUENCE hr_work_schedule_entry_s START WITH 1000;

CREATE TABLE hr_work_schedule_entry_t (HR_WORK_SCHEDULE_ENTRY_ID NUMBER(38,0) NOT NULL, HR_WORK_SCHEDULE NUMBER(38,0) NOT NULL, OBJ_ID VARCHAR2(36), VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, index_of_day DECIMAL(8,0) DEFAULT 0 NOT NULL, begin_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, end_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, CONSTRAINT PK_HR_WORK_SCHEDULE_ENTRY_T PRIMARY KEY (HR_WORK_SCHEDULE_ENTRY_ID));
CREATE SEQUENCE hr_work_schedule_s START WITH 1000;

CREATE TABLE hr_work_schedule_t (HR_WORK_SCHEDULE_ID NUMBER(38,0) NOT NULL, HR_WORK_SCHEDULE NUMBER(38,0) NOT NULL, WORK_SCHEDULE_DESC VARCHAR2(30) NOT NULL, EFFDT DATE DEFAULT '01-JAN-1980' NOT NULL, ACTIVE VARCHAR2(1) DEFAULT 'N', OBJ_ID VARCHAR2(36), VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, CONSTRAINT PK_HR_WORK_SCHEDULE_T PRIMARY KEY (HR_WORK_SCHEDULE_ID));
...
CREATE TABLE tk_assignment_t (TK_ASSIGNMENT_ID NUMBER(38,0) NOT NULL, PRINCIPAL_ID VARCHAR2(40), JOB_NUMBER NUMBER(38,0), EFFDT DATE DEFAULT '01-JAN-1980' NOT NULL, WORK_AREA NUMBER(38,0), TASK NUMBER(38,0), OBJ_ID VARCHAR2(36), VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, active VARCHAR2(1) DEFAULT 'N', timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, CONSTRAINT PK_TK_ASSIGNMENT_T PRIMARY KEY (TK_ASSIGNMENT_ID));
...
CREATE TABLE tk_clock_log_t (TK_CLOCK_LOG_ID NUMBER(38,0) NOT NULL, PRINCIPAL_ID VARCHAR2(40), JOB_NUMBER NUMBER(38,0), WORK_AREA NUMBER(38,0), TASK NUMBER(38,0), TK_WORK_AREA_ID NUMBER(38,0), TK_TASK_ID NUMBER(38,0), CLOCK_TS TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, CLOCK_TS_TZ VARCHAR2(50), CLOCK_ACTION VARCHAR2(2), IP_ADDRESS VARCHAR2(15), HR_JOB_ID NUMBER(38,0), USER_PRINCIPAL_ID VARCHAR2(40), TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, CONSTRAINT PK_TK_CLOCK_LOG_T PRIMARY KEY (TK_CLOCK_LOG_ID));
...
CREATE TABLE tk_hour_detail_hist_t (TK_HOUR_DETAIL_HIST_ID NUMBER(38,0) NOT NULL, TK_HOUR_DETAIL_ID NUMBER(38,0) NOT NULL, EARN_CODE VARCHAR2(3), HOURS DECIMAL(5,2), amount DECIMAL(6,2) DEFAULT 0, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, ACTION_HISTORY VARCHAR2(15), MODIFIED_BY_PRINCIPAL_ID VARCHAR2(40), TIMESTAMP_MODIFIED TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE tk_time_block_hist_t (TK_TIME_BLOCK_HIST_ID NUMBER(38,0) NOT NULL, TK_TIME_BLOCK_ID NUMBER(38,0), DOCUMENT_ID VARCHAR2(14), principal_id VARCHAR2(40), JOB_NUMBER NUMBER(38,0), TASK NUMBER(38,0), WORK_AREA NUMBER(38,0), TK_WORK_AREA_ID NUMBER(38,0), TK_TASK_ID NUMBER(38,0), EARN_CODE VARCHAR2(3), BEGIN_TS TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, BEGIN_TS_TZ VARCHAR2(50), END_TS TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, END_TS_TZ VARCHAR2(50), CLOCK_LOG_CREATED VARCHAR2(1) DEFAULT 'Y', HOURS DECIMAL(5,2), USER_PRINCIPAL_ID VARCHAR2(40), TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, ACTION_HISTORY VARCHAR2(15), MODIFIED_BY_PRINCIPAL_ID VARCHAR2(40), TIMESTAMP_MODIFIED TIMESTAMP DEFAULT CURRENT_TIMESTAMP, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, amount DECIMAL(6,2) DEFAULT 0, HR_JOB_ID NUMBER(38,0), CONSTRAINT PK_TK_TIME_BLOCK_HIST_T PRIMARY KEY (TK_TIME_BLOCK_HIST_ID));
CREATE SEQUENCE tk_time_block_s START WITH 1000;

CREATE TABLE tk_time_block_t (TK_TIME_BLOCK_ID NUMBER(38,0) NOT NULL, DOCUMENT_ID VARCHAR2(14), principal_id VARCHAR2(40), JOB_NUMBER NUMBER(38,0), WORK_AREA NUMBER(38,0), TASK NUMBER(38,0), TK_WORK_AREA_ID NUMBER(38,0), HR_JOB_ID NUMBER(38,0), TK_TASK_ID NUMBER(38,0), EARN_CODE VARCHAR2(3), BEGIN_TS TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, BEGIN_TS_TZ VARCHAR2(50), clock_log_begin_id NUMBER(38,0), END_TS TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, END_TS_TZ VARCHAR2(50), clock_log_end_id NUMBER(38,0), CLOCK_LOG_CREATED VARCHAR2(1) DEFAULT 'Y', HOURS DECIMAL(5,2), amount DECIMAL(6,2) DEFAULT 0, USER_PRINCIPAL_ID VARCHAR2(40), TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(38,0) DEFAULT 1 NOT NULL, ovt_pref VARCHAR2(5), CONSTRAINT PK_TK_TIME_BLOCK_T PRIMARY KEY (TK_TIME_BLOCK_ID));
