ALTER TABLE hr_py_calendar_t ADD COLUMN `FLSA_BEGIN_DAY` VARCHAR(9) NOT NULL DEFAULT 'SUN';
ALTER TABLE hr_py_calendar_t ADD COLUMN `FLSA_BEGIN_TIME` TIME NOT NULL DEFAULT '0:00:00';
