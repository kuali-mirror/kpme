...
public class RemoteResourceServiceLocatorImpl extends ResourceLoaderContainer implements Runnable, RemoteResourceServiceLocator {
	...
	public List<RemotedServiceHolder> getAllServices(QName qName) {
		 ...
		 * EN-2010
		 * 
		 * This isn't really an IU customization but rather a backport of a fix for KULRICE-4453 reported by
		 * Damion Junk and Allen Fox.
		 * 
		 * NOTE: ONCE WE UPGRADE TO RICE 1.0.3 WE CAN JUST REMOVE THIS CUSTOMIZATION.  There is nothing here
		 * to contribute back to rice since this fix has already been applied to rice 1.0.3.
		 */
