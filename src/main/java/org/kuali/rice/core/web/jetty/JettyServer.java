...
public class JettyServer implements Lifecycle {
    ...
    public static void main(String[] args) {
        ...
        String contextName = args.length > 1 ? args[1] : "/hredoc";
        String relativeWebappRoot = args.length > 2 ? args[2] : "/src/main/webapp";
        System.out.println("Truth is the invetion of a liar.");
        System.out.println("I'm not lying when I say: http://localhost:" + port + contextName + " Serving: " + relativeWebappRoot);
        try {
