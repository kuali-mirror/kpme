...
public class TimeSheetInitiateLookupableHelper extends KualiLookupableHelperServiceImpl {
	...
	private static final long serialVersionUID = -5841526685609197183L;
	...
	public List<HtmlData> getCustomActionUrls(BusinessObject businessObject, List pkNames) {
		...
		String tkTimeSheetInitId = timeSheetInitiateObj.getTkTimeSheetInitId();
		
		Properties params = new Properties();
		params.put(KRADConstants.BUSINESS_OBJECT_CLASS_ATTRIBUTE, getBusinessObjectClass().getName());
		params.put(KRADConstants.DISPATCH_REQUEST_PARAMETER, KRADConstants.MAINTENANCE_NEW_METHOD_TO_CALL);
		params.put("tkTimeSheetInitId", tkTimeSheetInitId);
