    ...
    public void assignShowDistributeButton(ClockActionForm caf) {
    	...
    	if(timesheetDocument != null) {
    		...
    		for(Assignment assignment: assignments) {
    			TimeCollectionRule rule = TkServiceLocator.getTimeCollectionRuleService().getTimeCollectionRule(assignment.getJob().getDept(), assignment.getWorkArea(), assignment.getJob().getDept(),assignment.getEffectiveDate());
		    	if(rule != null) {
