...
public class WorkAreaLookupableHelper extends KualiLookupableHelperServiceImpl {
	...
	AnchorHtmlData anchorHtmlData = new AnchorHtmlData(url + "/WorkAreaMaintenance.do?workAreaId=" + ((WorkArea)businessObject).getWorkAreaId(), KNSConstants.DOC_HANDLER_METHOD, KNSConstants.MAINTENANCE_EDIT_METHOD_TO_CALL);
