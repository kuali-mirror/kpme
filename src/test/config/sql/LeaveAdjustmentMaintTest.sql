...
insert into lm_accrual_category_t values('3000', 'AC1', 'testLP', 'test', 'D', 'D', '2010-01-01', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', 'Y', 'N', 'N', 'Y',now(), '1.5');	
insert into lm_leave_plan_t values ('3000',	'IU-SM', 'staff monthly', '01/01', '2011-01-01', 'F1248B7E-D13D-F3EE-20FF-9E428992F92C', '1', 'Y', '2012-01-07 11:38:02');
insert into lm_leave_code_t values ('3000',	'IU-SM', 'Y', 'AC1', 'TC1', 'testLC', 'testLC', 'D', 99,	'T', 'Y', 'N', 'N', null, 'Y', 'N', 'N', '2012-02-09', 'B2991ADA-E866-F28C-7E95-A897AC377D0C',	'1', 'Y', '2012-02-09 11:38:04');
