...
insert into hr_principal_attributes_t values('5001', '111', 'BWS-CAL', 'testLP','2010-01-01', 'Y','Y', null, '2010-01-01',now(), uuid(), '1', 'Y', null, 'Y', 'LM');
insert into lm_accrual_category_t values('3000', 'AC1', 'testLP', 'test', 'D', 'D', '2010-01-01', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', 'Y', 'N', 'N', 'Y',now(), '1.5', 'LC-DEFAULT', 'Y');	
...
insert into lm_leave_adjustment_t values (	'3000',	'10001',	'AC1',	'IU-SM',	'testLC',	10,	'test 1239',	'2012-01-31 11:03:11',	'8B5039D6-5775-87AA-9012-1A6EDEB0FD16',	1, null);