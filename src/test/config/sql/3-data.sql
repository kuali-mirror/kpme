...
INSERT INTO `hr_job_t` (`HR_JOB_ID`,`PRINCIPAL_ID`,`JOB_NUMBER`,`EFFDT`,`active`,`dept`,`TK_SAL_GROUP`,`PAY_GRADE`,`TIMESTAMP`,`OBJ_ID`,`VER_NBR`,`location`,`std_hours`,`fte`,`hr_paytype`) VALUES
  (1,  'admin', 30, '2010-01-01', 1, 'TEST-DEPT', 'SD1', 'SD1', '2010-08-1 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', 'SD1', '40.00', NULL, 'BW'),
	(12, 'admin', 1, '2010-08-01', 1, 'TEST-DEPT', 'A10', NULL, '2010-08-1 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(13, 'admin', 2, '2010-08-01', 1, 'TEST-DEPT', 'A12', NULL, '2010-08-10 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(14, 'admin', 2, '2010-08-11', 1, 'TEST-DEPT', 'A12', NULL, '2010-08-11 16:00:14', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
 (16, 'admin', 2, '2010-08-12', 1, 'TEST-DEPT', 'A12', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(17, 'eric', 1, '2010-08-12', 1, 'TEST-DEPT', '10', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(18, 'eric', 1, '2010-08-12', 1, 'TEST-DEPT', '10', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(19, 'eric', 2, '2010-08-10', 1, 'TEST-DEPT', '10', NULL, '2010-08-10 16:22:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(20, 'eric', 2, '2010-08-13', 1, 'TEST-DEPT', '11', NULL, '2010-08-13 16:22:22', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(21, 'admin', 3, '2010-08-15', 1, 'NODEP', 'NOP', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(22, 'admin', 4, '2010-08-15', 1, 'NODEP', 'A10', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(23, 'admin', 5, '2010-08-15', 1, 'LORA-DEPT', 'A10', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW'),
	(24, 'admin', 6, '2010-01-01', 1, 'SHFT-DEPT', 'A10', NULL, '2010-08-12 16:00:13', 'A9225D4A-4871-4277-5638-4C7880A57621', '1', '', '40.00', NULL, 'BW');
...
INSERT INTO `tk_dept_t` (`tk_dept_id`,`dept`,`DESCRIPTION`,`ORG`,`CHART`,`EFFDT`,`TIMESTAMP`,`ACTIVE`) VALUES
    ...
    (109 , 'LORA-DEPT'  , 'loras department' , 'LORA' , 'DEPT' , '2010-01-31' , '2010-07-27 10:25:13' , 1),
...
INSERT INTO `tk_work_area_t` (`TK_WORK_AREA_ID`, `WORK_AREA`, `EFFDT`,`ACTIVE`,`DESCR`,`DEPT`,`DEFAULT_OVERTIME_PREFERENCE`,`ADMIN_DESCR`,`USER_PRINCIPAL_ID`,`TIMESTAMP`,`OBJ_ID`,`VER_NBR`) VALUES
    (1  , 30,    '2010-01-01', 1, 'SDR1 Work Area',     'TEST-DEPT', NULL, 'work area admin description', 'admin', '2010-07-27 10:25:13', '7EE387AB-26B0-B6A6-9C4C-5B5F687F0E97', '20'),
    ...
    (104, '1000', '2010-01-05', 1, 'loras work area', 'LORA-DEPT', 'OT1', 'work area admin description2', 'admin', '2010-07-27 10:25:13', '7EE387AB-26B0-B6A6-9C4C-5B5F687F0E97', '20'),
...
INSERT INTO `tk_assignment_t` (`TK_ASSIGNMENT_ID`,`PRINCIPAL_ID`,`JOB_NUMBER`,`EFFDT`,`WORK_AREA`,`TASK`,`OBJ_ID`,`TIMESTAMP`,`VER_NBR`,`active`) VALUES
    (1  , 'admin' , 30, '2010-01-01' , 30 , 30, '8421CD29-E1F4-4B9A-AE33-F3F4752505CE' , '2010-07-27 10:25:13' , '1' , 1)  ,
...
INSERT INTO `TK_DEPT_EARN_CODE_T`
    ...
    (1                    , 'TEST-DEPT'  , 'SD1'          , 'RGH'       , 1          , 1          , 1           , '2010-08-01' , '2010-01-01 08:08:08' , 1)               ,
    (2                    , 'TEST-DEPT'  , 'SD1'          , 'RGN'       , 1          , 1          , 1           , '2010-08-01' , '2010-01-01 08:08:08' , 1)               ,    
...
INSERT INTO `TK_EARN_CODE_T` (`TK_EARN_CODE_ID`, `EARN_CODE`, `DESCR`, `RECORD_TIME`,`RECORD_HOURS`,`RECORD_AMOUNT`,`EFFDT`, `TIMESTAMP`, `ACTIVE`) VALUES
  (1  , 'SDR' , 'SHIFT DIFF'        , '1','0','0', '2010-01-01' , '2010-01-01 08:08:08' , 1) ,
...
INSERT INTO `hr_paytype_t` (`HR_PAYTYPE_ID`,`PAYTYPE`,`DESCR`,`CALENDAR_GROUP`,`REG_ERN_CODE`,`EFFDT`,`TIMESTAMP`,`HOLIDAY_CALENDAR_GROUP`,`OBJ_ID`,`VER_NBR`,`ACTIVE`) VALUES
	(1, 'BW', 'description', 'BWS-CAL', 'RGN', '2010-08-01', '2010-01-01 16:01:07', 'HOL', '47326FEA-46E7-7D89-0B13-85DFA45EA8C1', '1',1),
	(2, 'BW', 'description', 'BWS-CAL', 'RGN', '2010-01-01', '2010-01-01 16:01:07', 'HOL', '47326FEA-46E7-7D89-0B13-85DFA45EA8C1', '1',1);
...
INSERT INTO `tk_earn_group_t` (`tk_earn_group_id`,`earn_group`,`descr`,`effdt`,`active`,`OBJ_ID`,`VER_NBR`,`timestamp`) VALUES
  (  1,'SD1','Test SD1', '2010-01-01', 1, '', 1, '2010-01-01 01:01:01'),
