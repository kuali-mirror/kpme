...
/** Leave block */
insert into lm_leave_block_t (`lm_leave_block_id`, `leave_date`,`description`,  `principal_id` , `leave_code` ,`lm_leave_code_id` ,`lm_sys_schd_timeoff_id` ,`lm_accrual_category_id` ,`hours`, `apply_to_ytd_used`, `document_id`, `accrual_generated`, `block_id`,`ver_nbr`, `obj_id`, `timestamp`,`principal_id_modified`, `tk_assignment_id`, `request_status` ) values('1000', '2013-03-01', 'Send for Approval', 'admin', 'testLC', '1000','3000', '3000', '8', 'Appy to ytd', '12546', 'A', '0','1','B2991ADA-E866-F28C-7E95-A897AC377D0C', now(), 'admin',  '1100', 'P');
insert into lm_leave_block_t (`lm_leave_block_id`, `leave_date`,`description`,  `principal_id` , `leave_code` ,`lm_leave_code_id` ,`lm_sys_schd_timeoff_id` ,`lm_accrual_category_id` ,`hours`, `apply_to_ytd_used`, `document_id`, `accrual_generated`, `block_id`,`ver_nbr`, `obj_id`, `timestamp`,`principal_id_modified`, `tk_assignment_id`, `request_status` ) values('1001', '2013-03-02', 'Send for Approval 1', 'admin', 'testLC', '1000','3000', '3000', '8', 'Appy to ytd', '12546', 'A', '0','1','B2991ADA-E866-F28C-7E95-A897AC377D0C', now(), 'admin',  '1100', 'P');
insert into lm_leave_block_t (`lm_leave_block_id`, `leave_date`,`description`,  `principal_id` , `leave_code` ,`lm_leave_code_id` ,`lm_sys_schd_timeoff_id` ,`lm_accrual_category_id` ,`hours`, `apply_to_ytd_used`, `document_id`, `accrual_generated`, `block_id`,`ver_nbr`, `obj_id`, `timestamp`,`principal_id_modified`, `tk_assignment_id`, `request_status` ) values('1002', '2012-03-02', 'Approved Leave', 'admin', 'testLC', '1000','3000', '3000', '8', 'Appy to ytd', '12546', 'A', '0','1','B2991ADA-E866-F28C-7E95-A897AC377D0C', now(), 'admin',  '1100', 'A');
