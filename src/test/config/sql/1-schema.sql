...
ALTER TABLE tk_system_lunch_rl_t DROP COLUMN `BLOCK_HOURS` , DROP COLUMN `MIN_MINS` , ADD COLUMN `SHOW_LUNCH_BUITTON` VARCHAR(1) NULL DEFAULT '0'  AFTER `USER_PRINCIPAL_ID` ;
ALTER TABLE tk_dept_lunch_rl_t DROP COLUMN `CLOCK_REQUIRED_FL`;
