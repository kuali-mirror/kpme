...
-- insert into hr_calendar_entries_t (hr_calendar_entry_id, hr_calendar_id, calendar_name, begin_period_date, end_period_date) values ('10001', '3', 'BWS-CAL', '2012-03-15 00:00:00', '2012-03-01 00:00:00');
...
INSERT INTO lm_leave_document_header_t values ('1000', 'admin', '2012-03-04 00:00:00','2012-03-18 00:00:00', 'I', '7EE387AB-26B0-B6A6-9C4C-5B5F687F0E97', '1');
INSERT INTO lm_leave_document_header_t values ('1001', 'admin', '2012-03-18 00:00:00','2012-04-01 00:00:00', 'I', '7EE387AB-26B0-B6A6-9C4C-5B5F687F0E96', '1');
...
#insert into hr_calendar_entries_t (hr_calendar_entry_id, hr_calendar_id, calendar_name, begin_period_date, end_period_date) values ('10003', '2', 'BWS-CAL', ADDDATE(now(),-1), ADDDATE(now(),13));
#insert into hr_calendar_entries_t (hr_calendar_entry_id, hr_calendar_id, calendar_name, begin_period_date, end_period_date) values ('10004', '3', 'BWS-LM', ADDDATE(now(),-1), ADDDATE(now(),13));
#insert into hr_calendar_entries_t (hr_calendar_entry_id, hr_calendar_id, calendar_name, begin_period_date, end_period_date) values ('10005', '2', 'BWS-CAL', ADDDATE(now(),13), ADDDATE(now(),27));
#insert into hr_calendar_entries_t (hr_calendar_entry_id, hr_calendar_id, calendar_name, begin_period_date, end_period_date) values ('10006', '3', 'BWS-LM', ADDDATE(now(),13), ADDDATE(now(),27));
