...
insert into hr_principal_attributes_t values('testUser2', 'BWS-CAL', 'testLP2', '2012-03-01', 'Y', 'Y', null, '2012-03-01', now(), uuid(), '1', 'Y', 'LM', 'Y', 'Y');
...
insert into hr_principal_attributes_t values('testUser3', 'BWS-CAL', 'testLP3', '2012-03-01', 'Y', 'Y', null, '2012-03-01', now(), uuid(), '1', 'Y', 'LM', 'Y', 'Y');
