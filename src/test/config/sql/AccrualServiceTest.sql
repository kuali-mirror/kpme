...
insert into hr_principal_attributes_t values('testUser', 'BWS-CAL', 'ASN', 'testGroup', 'testLP', '2012-03-01', 'Y', 'Y', null, '2012-03-01', now(), uuid(), '1', 'Y', 'Y', 'LM');
insert into lm_accrual_category_t values('5000', 'testAC', 'testLP', 'test', 'M', '40', '2012-02-01', '8421CD29-E1F4-4B9A-AE33-F3F4752505CE', '1', null, null, 'Y', 30,'Y',now(), '1.5', 'testLC', 'Y');
...
insert into hr_job_t values ('5000', 'testUser', '1', '2010-01-01', 'TEST-DEPT', 'SD1', 'SD1', now(), uuid(), '1', '0.000000', 'SD1', '40.00', null, 'BW', 'Y',  'Y', 'N', 'N');
insert into hr_job_t values ('5001', 'testUser', '2', '2010-02-01', 'TEST-DEPT', 'SD1', 'SD1', now(), uuid(), '1', '0.000000', 'SD1', '40.00', null, 'BW', 'Y',  'Y', 'N', 'N');
insert into hr_job_t values ('5002', 'testUser', '3', '2010-03-01', 'TEST-DEPT', 'SD1', 'SD1', now(), uuid(), '1', '0.000000', 'SD1', '40.00', null,'BW', 'Y',  'Y', 'N', 'Y');

insert into lm_sys_schd_timeoff_t values ('5000', 'testLP', 'testAC', 'testLC', '2012-04-10', NULL, 'testLocation','testSSTO', '8', null, null, null, null, 'testH', '2012-03-01', uuid(), '1', 'Y', now());
