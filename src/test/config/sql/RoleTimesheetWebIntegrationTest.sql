...
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2000', 'testuser6', 'TK_DEPT_ADMIN', 'admin', NULL,'TEST-DEPT', NULL, '2010-08-20', now(), 'Y', NULL, NULL);
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2001', 'fran',      'TK_APPROVER',   'admin', '30', NULL, NULL,       '2010-08-20', now(), 'Y', NULL, NULL);
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2002', 'frank',     'TK_REVIEWER',   'admin', '30', NULL, NULL,       '2010-08-20', now(), 'Y', NULL, NULL);
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2003', 'edna',      'TK_GLOBAL_VO',  'admin', '30', NULL, NULL,       '2010-08-20', now(), 'Y', NULL, NULL);

# Employee Fred: No Role Needed
# insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2004', 'fred', 'TK_EMPLOYEE', 'admin', 'WA', NULL, NULL, '2010-08-20', now(), 'Y', NULL, NULL);

# Roles that are not applicable to see data from selected employee.
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2005', 'testuser1', 'TK_DEPT_ADMIN', 'admin', NULL,   'TEST-DEPT2', NULL, '2010-08-20',now(), 'Y', NULL, NULL);
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2006', 'testuser2', 'TK_APPROVER',   'admin', '1234', NULL, NULL, '2010-08-20', now(), 'Y', NULL, NULL);
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2007', 'testuser3', 'TK_REVIEWER',   'admin', '1234', NULL, NULL, '2010-08-20', now(), 'Y', NULL, NULL);
insert into hr_roles_t (hr_roles_id, principal_id, role_name, user_principal_id, work_area, dept, chart, effdt, timestamp, active, position_nbr, expdt) values ('2008', 'testuser4', 'TK_DEPT_VO',    'admin', NULL,   'TEST-DEPT2', NULL, '2010-08-20', now(), 'Y', NULL, NULL);
