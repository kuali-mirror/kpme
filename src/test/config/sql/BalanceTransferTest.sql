...
-- for testLookupPage
insert into LM_BALANCE_TRANSFER_T (`LM_BALANCE_TRANSFER_ID`, `LM_ACCRUAL_CATEGORY_RULES_ID`, `PRINCIPAL_ID`, `TRANSFER_AMOUNT`, `FROM_ACCRUAL_CATEGORY`, `AMOUNT_TRANSFERRED`, `TO_ACCRUAL_CATEGORY`, `FORFEITED_AMOUNT`, `EFFECTIVE_DATE`) values('5000', '5000', 'testUser', '8.0', 'fromAC', '5.0', 'toAC', '3.0', '2012-05-20');
