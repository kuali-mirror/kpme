...
insert into hr_earn_code_t values('10000', 'EC1', 'test1', '2012-02-01', 'Y', 'Y', 'B2991ADA-E866-F28C-7E95-A897AC377D0C', '1', now(), 'testAC', '1.5', '1.5', null, 'None', '99', 'T', 'N', 'Y', 'Y', 'Y', 'Y', 'test', null, 'N', 'Hours');
# earn code with allow_schd_leave = N
insert into hr_earn_code_t values('10001', 'EC2', 'test2', '2012-02-01', 'Y', 'Y', 'B2991ADA-E866-F28C-7E95-A897AC377D0C', '1', now(), 'testAC', '1.5', '1.5', null, 'None', '99', 'T', 'N', 'Y', 'Y', 'N', 'Y', 'test', null, 'N', 'Hours');