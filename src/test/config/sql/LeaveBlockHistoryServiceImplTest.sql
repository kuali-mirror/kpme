...
/** Leave block */
insert into lm_leave_block_t values ('1000', '2012-03-01', 'Test Description', 'admin', 'testLC', 1000, 3000, 3000, '8', 'Appy to ytd', '12546', 'A', 0,'1','B2991ADA-E866-F28C-7E95-A897AC377D0C', '1100', 'P', now(), 'admin');
insert into lm_leave_block_t values ('1001', '2012-03-02', 'Test Description', 'admin', 'testLC', 1000, 3000, 3000, '8', 'Appy to ytd', '12546', 'A', 0,'1','B2991ADA-E866-F28C-7E95-A897AC377D0C', '1100', 'P', now(), 'admin');
