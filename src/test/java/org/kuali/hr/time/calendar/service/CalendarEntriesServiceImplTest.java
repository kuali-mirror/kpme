...
public class CalendarEntriesServiceImplTest extends TkTestCase {
	...
	public void testGetAllCalendarEntriesForCalendarId() {
		...
		assertNotNull("Calendar entries not found for Calendar Id '2'" , ceList);
		assertTrue("Calendar entries not found for Calendar Id '2'", ceList.size() != 0);
	}
	@Test
	public void testGetAllCalendarEntriesForCalendarIdAndYear() {
		...
		assertNotNull("Calendar entries not found for Calendar Id '2' and year '2012'", ceList);
		assertTrue("Calendar entries not found for Calendar Id 2", ceList.size() != 0);
	}
}
