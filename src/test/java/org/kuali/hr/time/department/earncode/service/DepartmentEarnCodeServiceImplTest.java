...
public class DepartmentEarnCodeServiceImplTest extends TkTestCase {
	...
	public void testGetDepartmentEarnCodes() throws Exception {		
		...
		Assert.assertEquals("Wrong number of earn codes returned.", 5, departmentEarnCodes.size());
		// Test sorting of earn codes
		Assert.assertEquals("First Earn Code should be RGH", "RGH", departmentEarnCodes.get(0).getEarnCode());
		Assert.assertEquals("Second Earn Code should be SCK", "SCK", departmentEarnCodes.get(1).getEarnCode());
		Assert.assertEquals("Third Earn Code should be VAC", "VAC", departmentEarnCodes.get(2).getEarnCode());
		Assert.assertEquals("Forth Earn Code should be XYZ", "XYZ", departmentEarnCodes.get(3).getEarnCode());
		Assert.assertEquals("Fifth Earn Code should be XZZ", "XZZ", departmentEarnCodes.get(4).getEarnCode());
		...
		Assert.assertEquals("Wrong number of earn codes returned.", 2, departmentEarnCodes1.size());
